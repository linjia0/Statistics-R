...
## My past
I m **Linjia LI** from China. I was born in a small city in Sichuan Province. After [the earthquake in 2008](https://en.wikipedia.org/wiki/2008_Sichuan_earthquake), I moved to another city to  finish my study unti graduation from the university.

## My Volunteering experience
I joined _Junior Achievement[1]_ in my first year of university. I volunteered there to help more teenagers make life plan.

[1]:https://www.jaworldwide.org/

Here are some workshops I have volunteered before:
...
## Aboout now
Now I studied in ESMT Berlin. It is a new start for me to start a totally new life in such an unfamilliar country. I hope I will have a better future here.
...
plot1<- plot1 +
  labs(title = "lifeExp_China ",x = "year",y = "lifeExp")+
  NULL
...
```{r lifeExp_one_continent, paged.print=TRUE}
...
As the graph shows, there is an increasing trend of life expectancy since 1952. After the second world war, all countries were backing to the peace life. Moreover, due to the rapid development in China, people can live in a better life than before. It is time for people in this country to accumulate wealth and focus on health.That is why the life expectancy growed since 1952.
...
ggplot(brexit_results, aes(x = leave_share)) +
  ...
  labs(title = "percentage of votes in favor of Brexit",x = "leave_share",y = "percentage")+
  NULL
# density plot-- think smoothed histogram
ggplot(brexit_results, aes(x = leave_share)) +
  geom_density()+
  labs(title="density of votes in favour of Brexit")
...
ggplot(brexit_results, aes(x = leave_share)) +
  ...
  labs(title="The empirical cumulative distribution function (ECDF)",y="percentage")
...
ggplot(brexit_results, aes(x = born_in_uk, y = leave_share)) +
  ...
  theme_bw() +
  labs(title="scatterplot of votes in favor of Brexit")
  NULL
```
...
Through the graphs shown above, there are so many people who born in UK agree with the Brexit and the favor of that is around 40 to 60. I think the reason is that many people didn't see any benefits within the Europ and most of them regard Europe Union as a burden. However, through the density, most of them didn't really think about it. Most of the them are in favor of Brexit at around 50, which means they may not really care the result. And most of people who were born in the UK just afraid of immigration.
...
> The median and mean of most animals are not much different because they are more evenly distributed.
Finally, let us plot a few plots that show the distribution of incident_cost for each animal group.If the range is not so large, then the median is close to mean.However, the max and min incident cost of dog and cat stands out. The range between the median and mean is larger.
...
> The histogram graph makes sense.Horeses are more expensice to rescue than others. Since horses are too large to resecue. They like running, which increase the difficulty to resecue. The smaller animals are, the lower cost they rescue at.
...
-   Who did you collaborate with: Lei Wang
-   Approximately how much time did you spend on this problem set: 5 hours
-   What, if anything, gave you the most trouble: After installing the Rstudio for the first time, I realized that it goes wrong with my Chinese characters' user name. I tried many methods to change the path. However, it can't change the initial user name of Windows. Finally, I have to resign a new account for my Windows.
